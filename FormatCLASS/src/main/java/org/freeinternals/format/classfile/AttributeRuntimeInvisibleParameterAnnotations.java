...
public class AttributeRuntimeInvisibleParameterAnnotations extends AttributeInfo {
    ...
    AttributeRuntimeInvisibleParameterAnnotations(final u2 nameIndex, final String type, final PosDataInputStream posDataInputStream, final AbstractCPInfo[] cp)
